 ...
 <li><a href="https://www.tecno-mobile.com/pak/homepage"> <img src="camonimages/tecnoLogo.png" ></li></a>
  ...
  <li>
    ...
    <div class="dropdown-content">
      ...
      <a href="ayesha/Tecnoproject/tecnocamon1.html" class="horizontal"><img src="photos/camon.png"></a>
      	
      <a href="ayesha/Tecnoproject/tecnocamon1.html" class="horizontal"><img src="photos/spark.png"></a>
      <a href="ayesha/Tecnoproject/tecnocamon1.html" class="horizontal"><img src="photos/pop.png"></a>
      <a href="ayesha/Tecnoproject/tecnocamon1.html" class="horizontal"><img src="photos/pova.png"></a>
...
<div class="row">
  <div class="column">
    ...
    <img src="camonimages/camon19pro.png" alt="Snow" class="tecnoimg">
    <div class="centered2">CAMON 19 Pro Mondrian</div>
    <a href="camonspec.html">
  ...
  <div class="column">
    <div class="zoom">
    <div class="container1">
    <img src="camonimages/camon19neo.png" alt="Mountains" class="tecnoimg">
    <div class="centered2">CAMON 19 Neo</div>
...
<div class="column">
    <div class="zoom">
    <div class="container1">
    <img src="camonimages/proeco.png" alt="Forest" class="tecnoimg">
    <div class="centered2">CAMON 19 Pro</div>
    <a href="camonspec.html"><button class="btn1">Learn more</button></a>
     <button class="btn2">Buy Now</button>
...
<div class="row">
  ...
  <div class="column">
    <div class="zoom">
    <div class="container1">
    <img src="camonimages/premier.png" alt="Snow" class="tecnoimg">
    <div class="centered2">CAMON 18 Premier</div>
     <button class="btn1">Learn more</button>
     <button class="btn2">Buy Now</button>
  ...
  <div class="column">
    <div class="zoom">
    <div class="container1">
    <img src="camonimages/18p.png" alt="Mountains" class="tecnoimg">
    <div class="centered2">CAMON 18P</div>
    <button class="btn1">Learn more</button>
     <button class="btn2">Buy Now</button>
</div>
    </div>
...
<div class="column">
     <div class="zoom">
     <div class="container1">
    <img src="camonimages/18t.png" alt="Forest" class="tecnoimg">
     <div class="centered2">CAMON 18T</div>
     <button class="btn1">Learn more</button>
     <button class="btn2">Buy Now</button>
</div>
 </div>
