...
<div class="no-input">
    ...
    <div class="password">
    <input class="pass" type="password" name="password" placeholder="Please Enter Your Password" autocomplete="off" required> 
   </div> 

    <div class="confirm-pss">
        <input class="cpass" type="password" name="password" placeholder="Please confirm Password" autocomplete="off" required> 
        </div> 

    <div class="submit"></div> 
    <div class="btn-submit">
    <button class="btn-cntrl" type="submit" onclick="fun()" >Reset Password</button></div>
