...
<div class="registr">
  ...
  <div class="content-container">
    <div class="content" id="c1">
        <form class="form" action = "authentication.php" onsubmit = "return validation()"  name="f1">
            <div class="form-input">
            <input class="input-ctrl" type="text" name="account" placeholder="Please enter your account name or Email address" autocomplete="off"> 
